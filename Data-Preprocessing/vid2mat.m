% This code takes a video and group it's consecutive 10 frames to create one 
% sample and save all samples as .mat file. 
% ClassLabels.mat = file that contains names of all classes.
